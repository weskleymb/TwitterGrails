...
<div class="row">
    ...
    <g:hasErrors bean="${logAcessoInstance}">
        <div class="alert alert-warning alert-dismissible" role="alert">
            <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span
                    class="sr-only">Close</span></button>
            <ul class="errors" role="alert">
                <g:eachError bean="${logAcessoInstance}" var="error">
    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <g:form url="[resource: logAcessoInstance, action: 'update']" method="PUT" role="form">
                    <g:hiddenField name="version" value="${logAcessoInstance?.version}"/>
